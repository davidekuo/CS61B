...
public class IntList {
    ...
    public static IntList reverse(IntList A) {
        IntList intToFront = A;
        IntList frontOfReversed = null;
        while (intToFront != null) {
            IntList nextToFront = intToFront.rest;

            intToFront.rest = frontOfReversed;
            // moves intToFront to front of reversed singly-linked list

            frontOfReversed = intToFront;
            // move pointer for front of reversed singly-linked list to the new front
            intToFront = nextToFront;
        }
